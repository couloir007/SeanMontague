import{p as s}from"./index-C-ZRuDWU.js";import{T as n,t as i}from"./twig-CEFeP58X.js";import{a as l,D as r}from"./twig-D5Zl0i6Y.js";import"./index-RYns6xqu.js";l(n);n.cache(!1);const o=e=>e,h=(e={})=>{const t=i.twig({id:"/media/sean/External/www/OceanPortalPantheon/web/themes/custom/surface/source/patterns/base/typography/typography.twig",data:[{type:"raw",value:`<section class="demo-typography">
  <div class="just-for-gap">
    <div class="heading">Prose Content</div>
    <article class="prose">
      <p class="lead">Until now, trying to style an article, document, or blog post with out of the box styling has been a tedious task that required a keen eye for typography and a lot of complex custom CSS.</p>
      <p>By default, surface removes all of the default browser styling from paragraphs, headings, lists and more. This ends up being really useful for building application UIs because you spend less time undoing user-agent styles, but when you <em>really are</em> just trying to style some content that came from a rich-text editor in a CMS or a markdown file, it can be surprising and unintuitive.</p>
      <p>We get lots of complaints about it actually, with people regularly asking us things like:</p>
      <blockquote>
        <p>Why is Surface removing the default styles on my <code>h1</code> elements? How do I disable this? What do you mean I lose all the other base styles too?</p>
      </blockquote>
      ...
      <p>Simply adding a <code>prose</code> class that you can slap on any block of vanilla HTML content and turn it into a beautiful, well-formatted document:</p>
      <hr>
      <h2>What to expect from here on out</h2>
      <p>What follows from here is just a bunch of absolute nonsense I've written. It includes every sensible typographic element I could think of, like <strong>bold text</strong>, unordered lists, ordered lists, code blocks, block quotes, <em>and even italics</em>.</p>
      ...
      <p>Here's what a default <code>code</code> file looks like at the time of writing:</p>
<pre><code class="language-js">module.exports = {
  ...
  plugins: [],
      ...
      <p>I almost forgot to mention links, like <a href="https://www.uclahealth.org/">this link to the UCLA Health website</a>. We almost made them <strong><a href="https://www.uclahealth.org/">blue</a></strong> but that's so yesterday, so we went with dark gray, feels edgier.</p>
      ...
      <p>We also need to make sure inline code looks good, like if I wanted to talk about <code>&lt;span&gt;</code> elements.</p>
      ...
      <p>Another thing I've done in the past is put a <code>code</code> tag inside of a link, like if I wanted to tell you about the <a href="#"><code>surface</code></a> repository. I don't love that there is an underline below the backticks but it is absolutely not worth the madness it would require to avoid it.</p>
...
`,position:{start:0,end:0}}],precompiled:!0});t.options.allowInlineIncludes=!0;try{return o(t.render({attributes:new r,...e}))}catch(a){return o("An error occurred whilst rendering /media/sean/External/www/OceanPortalPantheon/web/themes/custom/surface/source/patterns/base/typography/typography.twig: "+a.toString())}},g={title:"Base/Typography"},y={name:"Typography",render:e=>s(h(e))},m=["Typography"];export{y as Typography,m as __namedExportsOrder,g as default};
