...
(() => {
  ...
  function safeLocalSet(key, value) {
    try {
      ...
      /* private mode / disabled — preference just will not persist */
    }
  }
  ...
  function reflect(toggle, unit) {
    toggle.querySelectorAll('.units-toggle__option').forEach((btn) => {
  ...
  function init(context) {
    context.querySelectorAll('.units-toggle:not([data-units-init])').forEach((toggle) => {
