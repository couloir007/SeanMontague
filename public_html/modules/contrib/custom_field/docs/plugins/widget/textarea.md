...
> [!Note]
> The `maxlength_js` setting is visible when the [MaxLength](https://www.drupal.org/project/maxlength){:target="_blank"} module is installed.

## Field types
- [string_long](../type/string-long.md)
