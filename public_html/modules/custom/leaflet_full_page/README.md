...
Prerequisites
- Enable modules: Serialization, REST, Views, Leaflet Full Page, edan_connector and the EDAN provider it depends on.
...
- /admin/config/development/leaflet-full-page/edan-test?edan_id=edanmdm:nmnhanthro_12345
- /admin/config/development/leaflet-full-page/edan-test?url=url:edanmdm:nmnhanthro_12345
...
- Routing: leaflet_full_page.routing.yml
...
Support & Maintenance
- Hook help: Admin > Help > Leaflet Full Page shows these instructions within Drupal.
