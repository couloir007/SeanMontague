...
namespace Drupal\map_page\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Administration settings form for the Map Page module.
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    $config = $this->config('map_page.settings');
    ...
    $form['endpoint_path'] = [
      ...
      '#description' => $this->t('URL path for the GeoJSON endpoint. Passed to JS as <code>drupalSettings.map_page.itemsEndpoint</code>. Appending a bundle name is optional (e.g. <code>/map-page/map-items/poi</code>).'),
      '#default_value' => $config->get('endpoint_path') ?? '/map-page/map-items',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->config('map_page.settings')
      ->set('bundle', trim($form_state->getValue('bundle')))
      ->set('geo_field', trim($form_state->getValue('geo_field')) ?: 'location')
      ->set('endpoint_path', trim($form_state->getValue('endpoint_path')) ?: '/map-page/map-items')
