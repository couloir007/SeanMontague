...
namespace Drupal\map_page\Controller;
 ...
 * configured default in map_page.settings. Field mapping and the
  ...
  public function dump(string $bundle = ''): JsonResponse {
    ...
    if (empty($bundle)) {
      return new JsonResponse([
        ...
        'features' => [],
        'error' => 'No bundle configured. Set a default bundle at /admin/config/map-page/settings.',
      ]);
    }
